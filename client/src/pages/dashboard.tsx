  ...
  return (
    <div className="flex flex-col h-full">
      <div className="p-3 pb-0 space-y-3">
        <div>
          <h1 className="text-lg font-bold tracking-tight" data-testid="text-dashboard-title">Panou Principal</h1>
          <p className="text-muted-foreground text-sm mt-0.5">Sumar general al asociatiei de proprietari</p>
        </div>
      </div>
